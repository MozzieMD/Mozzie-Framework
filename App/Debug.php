...
class Debug {
	...
	public static function var_dump($var, $return = false, $expandLevel = 3)
	{
		self::$hasArray = false;
	...
	public static function var_dump_plain($var, $expLevel, $depth = 0, $done = array())
	{
		...
		if (is_bool($var)) {
			...
			$html .= '<span style="color:#588bff;">string</span><span style="color:#999;">(</span>' . strlen($var) . '<span style="color:#999;">)</span> <strong style="color:#ff4b6c;">"' . self::htmlentities($var) . '"</strong>';
		} elseif (is_null($var)) {
			$html .= '<strong style="color:#ff6f1a;">NULL</strong>';
